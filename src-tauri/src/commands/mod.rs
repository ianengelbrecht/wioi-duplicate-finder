...
use crate::services::{AuthService, SessionService, SpecimenService, TaxonomyService, AgentService, GeographyService, ExportService};
...
#[tauri::command]
pub fn login_user(app: AppHandle, username: String, password: String) -> Result<Option<UserDto>, String> {
...
#[tauri::command]
pub fn save_captured_record(app: AppHandle, record: serde_json::Value) -> Result<serde_json::Value, String> {
    let captured_record: CapturedRecord = serde_json::from_value(record)
        .map_err(|e| format!("Invalid record format: {}", e))?;
...
#[tauri::command]
pub fn autocomplete_scientific_name(app: AppHandle, query: String) -> Result<Vec<TaxonAutocompleteResult>, String> {
...
pub fn autocomplete_geography(
    ...
    GeographyService::autocomplete_geography(&app, &field, &query, &country, &state_province, &county)
}
...
#[tauri::command]
pub fn save_export_settings(app: AppHandle, user_id: i32, format: String, mappings: String) -> Result<(), String> {
...
#[tauri::command]
pub fn export_session_csv(app: AppHandle, session_id: i32, filepath: String, csv_content: String) -> Result<String, String> {
...
pub fn restore_database_from_backup(app: AppHandle, backup_path: String) -> Result<(), String> {
    ...
    std::fs::copy(backup_file, &db_path).map_err(|e| format!("Failed to copy database file: {}", e))?;
